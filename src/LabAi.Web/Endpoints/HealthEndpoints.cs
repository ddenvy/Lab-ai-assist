...
/// API key is present, never the key itself (AGENT.md 3.2). Also reports vector index size and
/// dimension so operators can verify the store was rebuilt after ingest.
/// </summary>
public static class HealthEndpoints
{
    public static IEndpointRouteBuilder MapHealthEndpoints(this IEndpointRouteBuilder endpoints)
    {
        endpoints.MapGet("/health", static (GeminiOptions gemini, IVectorStore vectorStore, HttpContext context) =>
        {
            ...
            var response = new HealthResponse(
                ...
                VectorIndexSize: snapshot.Count,
                VectorDimension: snapshot.Dimension,
